...
contract PathFinder is HedgepieAccessControlled {
     ...
     */
    /// #if_succeeds {:msg "setPath does not modify the path"}  routers[_router] == _status
     ...
     */
    /// #if_succeeds {:msg "setPath does not modify the path"}  paths[_router][_inToken][_outToken].length == _path.length
    function setPath(
        address _router,
        address _inToken,
        address _outToken,
