...
describe("VenusLend Adapter Integration Test", function () {
    before("Deploy contract", async function () {
        ...
        await this.adapterList
            .connect(this.adapterManager)
            .addInfo(this.adapter[0].address, ["Venus::Lend::BUSD"], [this.strategy], [0], [0], [0]);
        await this.adapterList
            .connect(this.adapterManager)
        ...
        await this.ybNft.connect(this.adapterManager).updateOutputToken(1, busd, pksRouter);
