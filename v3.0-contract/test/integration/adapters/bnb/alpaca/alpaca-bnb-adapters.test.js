...
describe("Alpaca Adapters BNB Integration Test", function () {
    before("Deploy contract", async function () {
        ...
        const strategy = "0xd7D069493685A581d27824Fc46EdA46B7EfC0063"; // ibWBNB
        const swapRouter = "0x10ED43C718714eb63d5aA57B78B54704E256024E"; // pks rounter address
        const name = "Alpaca::Lend::BNB";
        ...
        await this.adapterList
            .connect(this.adapterManager)
            .addInfo(this.adapter[1].address, [name], [strategy], [0], [0], [0]);
        ...
        console.log("AlpacaLendAdapterBsc: ", this.adapter[0].address);
    ...
    describe("withdrawBNB() function test", function () {
        ...
        it("(4) should receive the BNB successfully after withdraw function for Bob", async function () {
            ...
            // increase reward for alpaca vault
            await this.rewarder.sendTransaction({
                to: this.rewardReceiver,
