...
describe("Alpaca Adapters Integration Test", function () {
    before("Deploy contract", async function () {
        ...
        const strategy = "0x158Da805682BdC8ee32d52833aD41E74bb951E59"; // ibUSDT
        const swapRouter = "0x10ED43C718714eb63d5aA57B78B54704E256024E"; // pks rounter address
        const name = "Alpaca::Lend::USDT";
        ...
        await this.ybNft.connect(this.adapterManager).updateOutputToken(1, USDT, swapRouter);
    ...
    describe("withdrawBNB() function test", function () {
        ...
        it("(4) should receive the BNB successfully after withdraw function for Bob", async function () {
            ...
            await this.usdtToken.connect(this.rewarder).transfer(this.rewardReceiver, ethers.utils.parseEther("0.3"));
