...
describe("Belt Adapters Integration Test", function () {
    before("Deploy contract", async function () {
        ...
        await this.adapter[0].initialize(strategy, stakingToken, strategy, swapRouter, name, this.authority.address);
        ...
        await this.adapterList
            .connect(this.adapterManager)
            .addInfo(this.adapter[0].address, ["Belt::Vault::BUSD"], [strategy], [0], [0], [0]);
        await this.adapterList
            .connect(this.adapterManager)
            .addInfo(
