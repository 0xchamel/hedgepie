...
describe("Belt Adapters BNB Integration Test", function () {
    before("Deploy contract", async function () {
        ...
        await this.adapter[0].initialize(strategy, wbnb, strategy, swapRouter, name, this.authority.address);
        ...
        console.log("BeltVaultBNBAdapterBsc: ", this.adapter[0].address);
